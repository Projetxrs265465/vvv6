...
var pixelParams =
  "&" + locSearch.substr(1) + "&sub19=" + rtkfbp + "&sub20=" + rtkfbc;
if (campaignID == "") {
...
function fixHrefWithClick(_rawData, _cachebuster, _rtkClickID) {
  document.querySelectorAll("a").forEach(function (el) {
    if (el.href.indexOf("lp.sistemaof.com/click") > -1) {
  ...
  if (!urlParams.get("rtkcid")) {
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        xhrr.open(
          "GET",
          "https://lp.sistemaof.com/view?clickid=" + rawData.clickid
        );
        xhrr.send();
      }
    };
    ...
    xhrTrack.open("GET", "https://lp.sistemaof.com/view?clickid=" + rtkClickID);
    xhrTrack.send();
